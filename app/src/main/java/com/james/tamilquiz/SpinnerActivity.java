...
import com.james.tamilquiz.SpinWheel.LuckyWheelView;
import com.james.tamilquiz.SpinWheel.model.LuckyItem;
import com.james.tamilquiz.databinding.ActivitySpinnerBinding;
    ...
    void updateCash(int index) {
        ...
        database
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(SpinnerActivity.this, "Coins added in your wallet!, Check your Wallet.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
